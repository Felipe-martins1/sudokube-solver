...
def genetic_algorithm(initial_puzzle, get_nums, pop_size=50, max_generations=1000000):
    ...
    for generation in range(max_generations):
        ...
        if stagnation >= MAX_STAGNATION:
            print(f"Não foi possível encontrar melhor solução. Estagnação por mais de {MAX_STAGNATION} gerações")
            initial_puzzle[:] = population[0]
            return True
